...
<body>
                            ...
                            <div class="col-lg-4 col-md-12 mb-6 mb-lg-0">
                                <div class="card shadow-2-strong">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem explicabo laudantium facere totam cupiditate harum accusantium atque, animi, nam tenetur aliquam quod, quis praesentium consequuntur! Ex doloremque
                                            dicta voluptatem at?</p>
                                        <a href="../blog/2022_02_02.html" class="btn btn-primary btn-rounded" aria-controls="#picker-editor">Read more</a>
                                    </div>
                                </div>
                            </div>
    ...
    <footer class="py-3 my-4 ">
        <ul class="nav justify-content-center border-bottom pb-3 mb-3 ">
            ...
            <li class="nav-item "><a href="ppdb.html " class="nav-link px-2 text-muted ">PPDB</a></li>
            <li class="nav-item "><a href="event.html " class="nav-link px-2 text-muted ">Berita</a></li>
            <li class="nav-item "><a href="aboutus.html " class="nav-link px-2 text-muted ">Tentang Kami</a></li>
        </ul>
